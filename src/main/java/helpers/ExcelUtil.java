...
public class ExcelUtil {
	...
	public boolean addHyperLink(String sheetName, String screenShotColName, String testCaseName, int index, String url,
		...
		for (int i = 2; i <= getRowCount(sheetName); i++) {
			if (getCellData(sheetName, screenShotColName, i).equalsIgnoreCase(testCaseName)) {
...
/*	@DataProvider(name = "testData2")
	...
	public void test2(String username , String password , String quick) {
	...
	//******************************************************************************************************
	//useful for data provide but advantage is that , no need to remember the column order of excel and Test argument
